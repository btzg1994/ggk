				...
				<div class="login_box">
					<div class="login">
						<form id="loginform" name="loginform" method="post"
							action="${pageContext.request.contextPath }/b/login">
							<p class="ptit">登录</p>
							<dl>
								<dd class="clearfix">
								...
								<dd class="clearfix">
									...
									<div class="fr">
										<img id="loginform:vCode"
											...
											width="90" height="35"
											onclick="javascript:document.getElementById('loginform:vCode').src='${pageContext.request.contextPath }/validatecode_back.jsp?_v='+Math.random();">
									</div>
									<div class="clear"></div>
									<p class="kbqc" onclick="javascript:document.getElementById('loginform:vCode').src='${pageContext.request.contextPath }/validatecode_back.jsp?_v='+Math.random();">看不清楚，换一个？</p>
								</dd>
								<dd class="clearfix" >
